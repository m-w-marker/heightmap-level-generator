...
- NICHT den Fluss-Spiegel im Shader gleich dem 128²-Spiegel setzen, sondern `RIVER_SINK` darunter. Die 1024²-Aue daneben liegt sonst stellenweise tiefer, das Wasser endet am nassen Streifen in der Luft → Zacken im Wasser-Mesh.
- NICHT den See-Spiegel per fester 3×3-Zellen-Dilatation auf 1024² übertragen, sondern über die bilineare Seemaske (`LAKE_EDGE`). Tiefer liegendes Gelände wird sonst an der Dilatationsgrenze als Quadrat abgeschnitten.
...
- NICHT Flüsse aus D8-Pfaden ungeglättet übernehmen, sondern Chaikin + Mäander (`meander`). Acht Richtungen auf 128² wirken wie Kanäle.
