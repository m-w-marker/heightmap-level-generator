...
- NICHT eine Quelle in anderer Auflösung als RES (Flow-Map = Erosionsraster RES/2) mit `resample(buf, res, n)` auf RES bringen, sondern mit `centres = true`. Sonst landet sie auf dem Vertex-Gitter und ist gegen die Heightmap um ½ Pixel verschoben.
