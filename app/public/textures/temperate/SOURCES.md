# Texturen temperate (CC0)

Geladen und neu codiert (JPG Albedo 80, Normal 80) von `tools/fetch-textures.mjs temperate`. Je Rolle
...
|---|---|---|---|
| ground | ambientCG `Grass004` | https://ambientcg.com/view?id=Grass004 | CC0 |
